...
vars = [
    ...
    # This is a list of every "world state" variable in the game. It should ideally contain
    ...
    ['TEnumAsByte<ELoadGroups>', 'CurrentLoadGroup', 'ELoadGroups::JVillageVista'],
    ['TEnumAsByte<EMarionettist>', 'CurrentMarionettist', 'EMarionettist::NoMarionettist'],

    ['bool', 'CurrentZoomedLinkingBookIsOpen', 'false'],
    ['bool', 'GehnIsTrapped', 'false'],
    ['bool', 'HaveTrapBook', 'true'],                       # Shortly gets set to false :P
    ...
    # J
    ##################################################################
    ['TEnumAsByte<ESubPosRot>', 'SubPosRot', 'ESubPosRot::Plat_N'],
    ...
    # T
    ##################################################################
    ['bool', 'T_GehnTempleSmallDoorOpen', 'false'],
    ['bool', 'T_GehnTempleHugeDoorOpen', 'false'],
    ['bool', 'T_ChoStillPassedOut', 'true'],
