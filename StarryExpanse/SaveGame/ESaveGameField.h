...
enum class ESaveGameField : uint8 {
  ...
  B_Basin_BalconyHatch_IsOpen,
  B_Basin_BalconyDoors_AreOpen,
  B_Shore_CartTunnelHatch_IsOpen,
  ...
  B_Lab_SouthDoor_IsOpen,
  B_Lab_Furnace_IsOpen,
  B_Lab_Press_IsCompressed,
  B_Lab_Drawers_IsDrawer1Open,
  B_Lab_Drawers_IsDrawer2Open,
  B_Lab_Drawers_IsDrawer3Open,
  B_Lab_Drawers_IsDrawer4Open,
  B_Lab_Drawers_IsDrawer5Open,
  B_Lab_DuctGrate_IsOpen,
