...
ULoadGroupInfo::ULoadGroupInfo(const FObjectInitializer &ObjectInitializer)
  ...
  /*
    ...
    LoadGroups.insert(LgEntry(
        ELoadGroups::BShit,
        LoadgroupInfoEntry(FString("BShit"),
        {
            FName("A_Journals")
        }
    )));
    ...
    LoadGroups.insert(LgEntry(
        ELoadGroups::BCentral,
        LoadgroupInfoEntry(FString("BCentral"),
        {
            FName("A_Journals"),
            FName("S_Lighting_Riven"),
            FName("S_PostProcessing_Riven"),
    ...
    LoadGroups.insert(LgEntry(
        ...
        LoadgroupInfoEntry(FString("BBalcony"),
        {
            ...
            FName("B_Lab"),
            FName("B_Basin"),
            FName("B_FireMarbleChamber")
        }
    )));

    LoadGroups.insert(LgEntry(
        ELoadGroups::BFiremarbleDistrict,
        LoadgroupInfoEntry(FString("BFiremarbleDistrict"),
        {
            FName("A_Journals"),
            FName("S_Lighting_Riven"),
            FName("S_PostProcessing_Riven"),
    ...
    LoadGroups.insert(LgEntry(
        ...
        LoadgroupInfoEntry(FString("BLabDistrict"),
        {
            FName("A_Journals"),
            FName("S_Lighting_Riven"),
            FName("S_PostProcessing_Riven"),
